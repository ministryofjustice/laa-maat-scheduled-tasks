...
class XhibitDataServiceTest {
    ...
    void buildRecordSheets_Response_whenNoDataFound_thenReturnsEmptyList() {
        ...
        GetRecordSheetsResponse recordSheetsResponse = xhibitDataService.buildRecordSheetsResponse(RecordSheetType.TRIAL, null);
    ...
    void buildRecordSheets_Response_throwsException_whenUnhandledAwsExceptionOccurs() {
        ...
        assertThrows(XhibitDataServiceException.class, () -> xhibitDataService.buildRecordSheetsResponse(RecordSheetType.TRIAL, null));
    }
