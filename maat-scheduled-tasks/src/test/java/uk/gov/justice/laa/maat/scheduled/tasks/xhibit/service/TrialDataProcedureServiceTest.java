...
class TrialDataProcedureServiceTest {

    @Mock
    private StoredProcedureService storedProcedureService;

    private TrialDataProcedureService procedureService;

    @BeforeEach
    void setUp() {
        procedureService = new TrialDataProcedureService(storedProcedureService);
    }

    @Test
    void call_returnsSuccess_whenProcedureHasNoErrors() {
        XhibitTrialDataEntity entity = getTrialDataEntity(234, "trial1.txt");

        StoredProcedureResponse response = new StoredProcedureResponse(List.of());
        when(storedProcedureService.callStoredProcedure(
                eq(StoredProcedure.TRIAL_DATA_TO_MAAT_PROCEDURE), anyList()))
                .thenReturn(response);
    ...
    void call_returnsFailure_whenProcedureHasErrorCodeAndMessage() {
        ...
        XhibitTrialDataEntity entity = getTrialDataEntity(456, "trial2.txt");
    ...
    void call_returnsFailure_whenStoredProcedureThrowsException() {
        ...
        XhibitTrialDataEntity entity = getTrialDataEntity(789, "trial3.txt");
    ...
    void getProcedureParameters_buildsExpectedInputsAndOutputs() {
        XhibitTrialDataEntity entity = XhibitTrialDataEntity.builder().id(42).build();
    ...
    private static XhibitTrialDataEntity getTrialDataEntity(int id, String filename) {
        return XhibitTrialDataEntity.builder()
                .id(id)
                .filename(filename)
                .build();
    }
